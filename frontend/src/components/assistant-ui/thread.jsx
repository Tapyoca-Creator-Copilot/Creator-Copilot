    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <h1
            className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both font-bold text-xl xl duration-200">
            Hi, I’m Tapy!
          </h1>
          <p
            className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-muted-foreground text-lg delay-75 duration-200">
    ...
    <MessagePrimitive.Root
      ...
      <div
        ...
        <AuiIf
          ...
          <div
            className="aui-assistant-message-thinking text-muted-foreground text-sm"
            aria-live="polite">
            Tapy is thinking...
          </div>
        </AuiIf>
